...
<head>
	...
	<title>Raspberry Pi Web Interface - Register</title>
	...
	<div class = "container-fluid">
		<nav>
			...
			<?php
				...
				if(!isset($_SESSION['username'])){
					echo "<a class = 'link-item' href = 'register_screen.php' style = 'background-color:#bd0d00; color: #ffffff;'>Register</a>";
				}
		...
		<div class = "col-lg-12">
			<form id = "register" name = "register" action="includes/attempt_register.php" method="POST">
